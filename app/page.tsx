  ...
  <main className={`min-h-screen overflow-hidden transition-colors duration-700 ${theme.page}`}>
    <div className="pointer-events-none fixed inset-0">
      ...
      <div className="relative mx-auto max-w-[1580px] px-5 pt-40 lg:px-8">
        <nav className={`sticky top-0 z-40 mb-6 flex items-center justify-between rounded-[2rem] border px-5 py-4 backdrop-blur-2xl ${theme.panel}`}>
          <div className="flex items-center gap-3">
            <div className="relative mx-auto max-w-[1580px] px-5 pt-2 pb-5 lg:px-8">
...
>
  ...
  <Image
    ...
    fill
    className="object-contain drop-shadow-[0_0_90px_rgba(255,76,16,.82)]"
    priority
  />
</motion.div>
            </div>
...
>
...

  {
    ...
    glow: 'rgba(255,40,80,.38)',
      ...
      <div
        key={item.title}
        className={`neon-border group relative overflow-hidden rounded-[2rem] border p-6 backdrop-blur-2xl transition-all duration-500 hover:-translate-y-3 hover:rotate-x-2 hover:rotate-y-1 hover:shadow-[0_35px_90px_rgba(255,120,40,.18)] transform-gpu ${theme.panel}`}
      >
...
<div className="absolute inset-0 opacity-0 transition duration-500 group-hover:opacity-100 bg-[linear-gradient(120deg,transparent,rgba(255,255,255,.10),transparent)]"></div>
  ...
  className="group relative overflow-hidden rounded-[1.4rem] border border-white/10 bg-white/30 px-6 py-3 text-sm font-bold text-white backdrop-blur-2xl transition-all duration-300 hover:-translate-y-1 hover:border-orange-400/30 hover:shadow-[0_0_30px_rgba(255,120,40,.22)]"
>
